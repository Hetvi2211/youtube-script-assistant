...
def handle_generation():
    """Validate input and generate titles and a script."""
    ...
    try:
        ...
        st.error("Something went wrong while creating your content. Please try again.")
    finally:
        st.session_state.is_processing = False
...
def render_results():
    ...
    st.caption("Your title ideas and video script are ready to review.")
...
def main():
    ...
    with st.sidebar:
        ...
        st.text_area(
            ...
            key="topic",
            height=100,
            placeholder="e.g. How small habits can improve your mornings",
    ...
    with input_col:
        st.caption("Create title ideas and a structured script for your next video.")
